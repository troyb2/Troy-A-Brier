...
%	{CV~~Attached}
	...
	\begin{cvletter}
		...
		%Therefore, 
		I am motivated by the \companyname's mission to revolutionize health discovery on a global scale.
		I am particularly drawn to~\companyname's perspective that health should be proactive and personalized through innovation in diagnostics, therapeutics, and communication.
