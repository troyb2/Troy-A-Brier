...
\newcommand{\companyname}{GEMMA Biotherapeutics}
\newcommand{\role}{Senior Bioinformatician}
...
%	{}
	...
	\begin{cvletter}
		...
		Therefore, I am inspired by \companyname's mission to speed the research of and global access to life-changing advanced therapies for those living with rare diseases.
%		to make personalized genetic testing and diagnostics part of the standard of care to protect health and enable earlier and more targeted interventions that lead to longer, healthier lives.
%		Human biology is complex, and the treatment for one is not guaranteed to be the treatment for another.
		I am particularly drawn to~\companyname's commitment as an emerging therapeutics company towards research and innovation targeted beyond the lab, and 
%		 global leader in medical testing working to fundamentally change the management of disease worldwide by implementing relatively simple testing to detect disease early and proactively inform treatment.		
...
%		I am think I am a quality candidate for the \brole~at the \companyname.
		...
		Most relevant to the position is my previous experience with sequencing data from varying methodologies (Illumina, PacBio, and ONT), where I integrated various software and algorithms to compared and predict complex relationships within the data sets. 
